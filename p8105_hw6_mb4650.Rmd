...
```
The distribution of r-squared values appears to be left skewed with it centered around 0.91. 
...
```
The distribution of log(beta0*beta1) appears to be approximately normally distributed with a center around 2.01. 
