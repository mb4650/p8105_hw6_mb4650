...
Based on the variables in the dataset, I think that a model for the
baby’s birth weight should have mother’s age at delivery, number of
live births prior to pregnancy, and average number of cigarettes smoked
as predictors. I will start by creating my model:
...
births predictor is not significant.
...
The distribution of r-squared values appears to be left skewed with it
centered around 0.91.
...
normally distributed with a center around 2.01.
